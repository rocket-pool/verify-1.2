...
const contractMap = {
  ...
  newRocketMinipoolQueue: 'RocketMinipoolQueue',
  ...
  newRocketNodeDistributorDelegate: 'RocketNodeDistributorDelegate',
  newRocketMinipoolFactory: 'RocketMinipoolFactory',
  newRocketNetworkFees: 'RocketNetworkFees',
...
const provider = new ethers.providers.JsonRpcProvider(process.env.ETH_RPC, process.env.NETWORK)
